...
public class GENFeedAdapter extends RecyclerView.Adapter<GENFeedAdapter.GENFeedViewHolder> {
    Context context;
    ArrayList<GENFeedItems> items = new ArrayList<>();

    public GENFeedAdapter(Context context, DatabaseReference ref, String UID){
