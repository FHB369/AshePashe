...
public class HistoryFeedAdapterSP extends RecyclerView.Adapter<HistoryFeedAdapterSP.RequestViewHolder> {
    Context context;
    ArrayList<RequestItem> items = new ArrayList<>();

    public HistoryFeedAdapterSP(Context context, DatabaseReference ref, String UID){
