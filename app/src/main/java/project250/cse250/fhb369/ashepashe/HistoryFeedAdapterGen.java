...
public class HistoryFeedAdapterGen extends RecyclerView.Adapter<HistoryFeedAdapterGen.RequestViewHolder> {
    Context context;
    ArrayList<RequestItem> items = new ArrayList<>();

    public HistoryFeedAdapterGen(Context context, DatabaseReference ref, String UID){
