 ...
 * {@link SignUpSP.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SignUpSP#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SignUpSP extends Fragment {
     ...
     * @return A new instance of fragment SignUpSP.
     */
    // TODO: Rename and change types and number of parameters
    public static SignUpSP newInstance(String param1, String param2) {
        SignUpSP fragment = new SignUpSP();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_sign_up_s, container, false);

        photoPicker = v.findViewById(R.id.photo_chooser_sp);
        progressBar = v.findViewById(R.id.progressBar_sp);
        shadow = v.findViewById(R.id.shadow_sign_up_sp);
        shadow.setVisibility(View.GONE);
        progressBar.setVisibility(View.GONE);

        final EditText name = v.findViewById(R.id.name_sp),
                email = v.findViewById(R.id.email_sp),
                password = v.findViewById(R.id.password_sp),
                mobile = v.findViewById(R.id.mobile_sp);
        Button signUpGen = v.findViewById(R.id.btn_sign_up_sp);
                                        ...
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            riversRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    shadow.setVisibility(View.GONE);
                                                    progressBar.setVisibility(View.GONE);
                                                    Intent intent = new Intent(getActivity(), SP_Home.class);
