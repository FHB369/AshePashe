...
public class EditProfileGEN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_profile_gen);

        photoPicker = findViewById(R.id.photo_chooser_gen_profile);
        progressBar = findViewById(R.id.progressBar_gen_profile);
        shadow = findViewById(R.id.shadow_sign_up_gen_profile);
        shadow.setVisibility(View.GONE);
        progressBar.setVisibility(View.GONE);

        final EditText name = findViewById(R.id.name_gen_profile),
                passwordOld = findViewById(R.id.password_gen_profile_old),
                passwordNew = findViewById(R.id.password_gen_profile_new);
        Button update = findViewById(R.id.btn_update_gen_profile);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("USERS/GENERAL_USERS").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
    ...
    private void updateUser(final String NAME, final String EMAIL, String PASSWORD_OLD, String PASSWORD_NEW){
